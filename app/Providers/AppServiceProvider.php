...
use App\Domains\Backoffice\Users\Repositories\BackofficeUsersRepository;
use App\Domains\Backoffice\Users\Repositories\Interfaces\BackofficeUsersRepositoryInterface;
use App\Domains\Backoffice\Users\Services\BackofficeUsersService;
...
class AppServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(BackofficeUsersRepositoryInterface::class, BackofficeUsersRepository::class);
        $this->app->bind(BackofficeUsersServiceInterface::class, BackofficeUsersService::class);
